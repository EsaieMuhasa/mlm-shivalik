...
class Config extends ApplicationComponent
{
    ...
    public function get($name)
    {
        if (empty($this->definitions)) {
            ...
            //======================================================
            $xml = new \DOMDocument();
            $xmlFile = dirname(__DIR__).'/Config/config.xml';
            ...
            if ($readFile===false) {
                throw new LibException('Impossible de parser le fichier de configuration globale "'.$this->getApplication()->getName().'" => ('.$xmlFile.')');
            }
            ...
            $readFile = $xml->load($xmlFile);
            if ($readFile===false) {
                throw new LibException('Impossible de parser le fichier de configuration de l\'application "'.$this->getApplication()->getName().'" => ('.$xmlFile.')');
            }
    ...
    public function getUser($pseudo)
    {
        if (empty($this->users)) {
            ...
            if (!file_exists($xmlFile)) {
                throw new LibException('Le fichier de configuration de l\'application "'.$this->getApplication()->getName().'" n\'existe pas sur le serveur. =>'.$xmlFile);
            }
            /**
             * @var \DOMDocument $readFile
             */

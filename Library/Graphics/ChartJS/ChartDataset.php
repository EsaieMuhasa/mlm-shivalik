...
class ChartDataset
{
    ...
    /**
     * @return mixed <multitype:number , multitype:\Library\Graphics\ChartJS\ChartPoint >
     */
    ...
    /**
     * @param Ambigous <multitype:number , multitype:\Library\Graphics\ChartJS\ChartPoint > $data
     */

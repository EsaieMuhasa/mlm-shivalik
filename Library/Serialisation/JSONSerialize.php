        ...
        {//Iteration des poropriete d'un objet
            ...
            if (method_exists($this, $methodGET) && is_object($this->$methodGET())) {//Pour les objets
                ...
                if ($sizeArray!=0) {
                    ...
                    if (!preg_match(AbstractFormValidator::RGX_INT, array_key_first($this->$methodGET()))) {
                        $isObject = true;
                    }
                ...
                if (method_exists($this, $methodGET)) {
                    if ((is_numeric($this->$methodGET()) || is_bool($this->$methodGET())) 
                        && !preg_match(AbstractFormValidator::RGX_TELEPHONE_RDC, $this->$methodGET())  && !preg_match(AbstractFormValidator::RGX_TELEPHONE, $this->$methodGET())) {

...
/**
 * @var Stock[] $stocks
 * @var AuxiliaryStock $auxiliary
 */
$stocks = $_REQUEST[ProductsController::ATT_STOCKS];
$auxiliary = isset($_REQUEST[ProductsController::ATT_STOCK]) ? $_REQUEST[ProductsController::ATT_STOCK] : null;
?>
<section class="panel">
    <header class="panel-heading"> <?php echo (isset($_GET['stockId'])? 'Update':'Send new') ?> Stock.</header>

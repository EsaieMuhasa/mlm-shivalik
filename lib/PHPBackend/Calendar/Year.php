...
class Year
{
    ...
    public function get(int $index) : Month {
        if ($index < 1 || $index > 12) {
            throw new PHPBackendException('L\'index du mois doit etre une valeur compise entre 1 et 12');
        }
    ...
    public function addSelectedMonth (int $index) : void {
        if ($index < 1 || $index > 12) {
            throw new PHPBackendException("Index invalide en paranetre de la methode addSelectedMonth() : {$index}");
        }
    ...
    public function removeSelectedMonth(int $index) : void {
        if ($index < 1 || $index > 12) {
            throw new PHPBackendException("Index invalide en paranetre de la methode removeSelectedMonth() : {$index}");
        }

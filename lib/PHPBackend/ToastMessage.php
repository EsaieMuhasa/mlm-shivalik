...
class ToastMessage
{
     ...
     * @throws PHPBackendException si l'attribut n'existe pas dans la classe, ou si son accesseur n'existe pas
     * @return mixed
     */
    public function __get($attributeName)
    {
        ...
        if (is_callable(array($this, $method))) {
            return $this->$method();
        }else throw new PHPBackendException('L\'attribut '.$attributeName.' n\'est pas definie dans la classe ToastMessage');
    }

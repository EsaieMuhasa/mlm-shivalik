...
class HTTPApplication implements Application
{
    ...
    /**
     * le namespace de base de l'application encours de consultation
     *
     * @var string
     */
    protected $namespace;
     ...
     */
    public function __construct(string $name, string $namespace, string $container, ?Application $source = null)
    {
        if ($source == null) {
...
//             session_set_save_handler($hadler, true);
    ...
    public final function getController() : Controller
    {
        ...
        $controllerClass = "{$this->namespace}\\Modules\\{$matchRoute->getModule()}\\{$matchRoute->getModule()}Controller";

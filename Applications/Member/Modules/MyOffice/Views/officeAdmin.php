...
<?php if (!isset($_REQUEST[MyOfficeController::ATT_OFFICE_ADMIN]) || $_REQUEST[MyOfficeController::ATT_OFFICE_ADMIN] == null) { ?>
<a class="btn btn-primary" href="admin.html">
	<span class="fa fa-plus"></span> Create an administrator account for this office
</a>
<?php } else { 
$admin = $_REQUEST[MyOfficeController::ATT_OFFICE_ADMIN]; ?>
<div class="row">

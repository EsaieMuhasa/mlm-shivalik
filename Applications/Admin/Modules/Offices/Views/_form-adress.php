		...
		<div class="col-md-6">
    		<div class="form-group">
    			...
    			<select name="country" id="localisation-country" class="form-control" >
        			...
        			<option value="<?php echo $country->id; ?>" title="<?php echo htmlspecialchars($country->abbreviation); ?>" <?php echo ((isset($_POST['country']) && $_POST['country'] == $country->id)? 'selected="selected"':''); ?>>
